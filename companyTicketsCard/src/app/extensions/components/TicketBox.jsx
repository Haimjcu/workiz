...
export const TicketBox = ({ ticket }) => {
  ...
  return (
    <>
      <Box style= {{border:"thick", padding:"md", borderRadius:"md" , backgroundColor:"white"}}>
        ...
        <Button variant="primary" onClick={handleButtonClick}>Comments: {ticket.count}</Button>
      </Box>
      <Divider />
    </>
